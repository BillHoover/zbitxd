...
void si5351_reset() { i2cSendRegister(SI_PLL_RESET, 0xA0); }

void si5351a_clkoff(uint8_t clk) {
  // i2c_init();
  i2cSendRegister(clk, 0x80); // Refer to SiLabs AN619 to see bit values - 0x80
...
void si5351_set_calibration(int32_t cal) { xtal_freq_calibrated = cal; }
