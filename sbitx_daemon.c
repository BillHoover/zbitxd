/*
The initial sync between the gui values, the core radio values, settings, et al
are manually set.
*/
...
struct band band_stack[] = {
    {"80M",
     ...
     4000000,
     0,
     {3500000, 3574000, 3600000, 3700000},
     {MODE_CW, MODE_LSB, MODE_CW, MODE_LSB}},
    {"60M",
     5250000,
     5500000,
     0,
     {5251500, 5354000, 5357000, 5360000},
     {MODE_CW, MODE_USB, MODE_USB, MODE_USB}},
    {"40M",
     7000000,
     7300000,
     0,
     {7000000, 7040000, 7074000, 7150000},
     {MODE_CW, MODE_CW, MODE_USB, MODE_LSB}},
    {"30M",
     10100000,
     10150000,
     0,
     {10100000, 10100000, 10136000, 10150000},
     {MODE_CW, MODE_CW, MODE_USB, MODE_USB}},
    {"20M",
     14000000,
     14400000,
     0,
     {14000000, 14400000, 14074000, 14200000},
     {MODE_CW, MODE_CW, MODE_USB, MODE_USB}},
    {"17M",
     18068000,
     18168000,
     0,
     {18068000, 18100000, 18110000, 18160000},
     {MODE_CW, MODE_CW, MODE_USB, MODE_USB}},
    {"15M",
     21000000,
     21500000,
     0,
     {21100000, 21500000, 21074000, 21250000},
     {MODE_CW, MODE_CW, MODE_USB, MODE_USB}},
    {"12M",
     24890000,
     24990000,
     0,
     {24890000, 24910000, 24950000, 24990000},
     {MODE_CW, MODE_CW, MODE_USB, MODE_USB}},
    {"10M",
     28000000,
     29700000,
     0,
     {28000000, 28000000, 28074000, 28250000},
     {MODE_CW, MODE_CW, MODE_USB, MODE_USB}},
};
...
struct field main_controls[] = {
    ...
    {"#10m", NULL, 50, 5, 40, 40, "10M", 1, "1", FIELD_BUTTON, "", 0, 0, 0,
     COMMON_CONTROL},
    {"#12m", NULL, 90, 5, 40, 40, "12M", 1, "1", FIELD_BUTTON, "", 0, 0, 0,
     COMMON_CONTROL},
    {"#15m", NULL, 130, 5, 40, 40, "15M", 1, "1", FIELD_BUTTON, "", 0, 0, 0,
     COMMON_CONTROL},
    {"#17m", NULL, 170, 5, 40, 40, "17M", 1, "1", FIELD_BUTTON, "", 0, 0, 0,
     COMMON_CONTROL},
    {"#20m", NULL, 210, 5, 40, 40, "20M", 1, "1", FIELD_BUTTON, "", 0, 0, 0,
     COMMON_CONTROL},
    {"#30m", NULL, 250, 5, 40, 40, "30M", 1, "1", FIELD_BUTTON, "", 0, 0, 0,
     COMMON_CONTROL},
    {"#40m", NULL, 290, 5, 40, 40, "40M", 1, "1", FIELD_BUTTON, "", 0, 0, 0,
     COMMON_CONTROL},
    {"#60m", NULL, 330, 5, 40, 40, "60M", 1, "1", FIELD_BUTTON, "", 0, 0, 0,
     COMMON_CONTROL},
    {"#80m", NULL, 370, 5, 40, 40, "80M", 1, "1", FIELD_BUTTON, "", 0, 0, 0,
     COMMON_CONTROL},
    {"#record", do_record, 420, 5, 40, 40, "REC", 40, "OFF", FIELD_TOGGLE,
     "ON/OFF", 0, 0, 0, COMMON_CONTROL},
    {"#set", NULL, 460, 5, 40, 40, "SET", 1, "", FIELD_BUTTON, "", 0, 0, 0,
     COMMON_CONTROL},
    {"r1:gain", NULL, 375, 5, 40, 40, "IF", 40, "60", FIELD_NUMBER, "", 0, 100,
     1, COMMON_CONTROL},
    {"r1:agc", NULL, 415, 5, 40, 40, "AGC", 40, "SLOW", FIELD_SELECTION,
     "OFF/SLOW/MED/FAST", 0, 1024, 1, COMMON_CONTROL},
    {"tx_power", NULL, 455, 5, 40, 40, "DRIVE", 40, "40", FIELD_NUMBER, "", 0,
     100, 5, COMMON_CONTROL},

    {"r1:freq", do_tuning, 600, 0, 150, 49, "FREQ", 5, "14000000", FIELD_NUMBER,
     "", 500000, 30000000, 100, COMMON_CONTROL},

    {"r1:volume", NULL, 755, 5, 40, 40, "AUDIO", 40, "60", FIELD_NUMBER, "", 0,
     100, 1, COMMON_CONTROL},
    ...
    {"#rit", NULL, 600, 50, 40, 40, "RIT", 40, "OFF", FIELD_TOGGLE, "ON/OFF", 0,
     0, 0, COMMON_CONTROL},
    {"#vfo", NULL, 640, 50, 40, 40, "VFO", 1, "A", FIELD_SELECTION, "A/B", 0, 0,
     0, COMMON_CONTROL},
    ...
    {"#bw", do_bandwidth, 495, 5, 40, 40, "BW", 40, "", FIELD_NUMBER, "", 50,
     5000, 50, COMMON_CONTROL},

    /* logger controls */

    {"#contact_callsign", do_text, 5, 50, 85, 20, "CALL", 70, "", FIELD_TEXT,
     "", 0, 11, 0, COMMON_CONTROL},
    {"#rst_sent", do_text, 90, 50, 50, 20, "SENT", 70, "", FIELD_TEXT, "", 0, 7,
     0, COMMON_CONTROL},
    ...
    {"#exchange_sent", do_text, 240, 50, 50, 20, "NR", 70, "", FIELD_TEXT, "",
     0, 7, 0, COMMON_CONTROL},
    {"#enter_qso", NULL, 290, 50, 40, 40, "SAVE", 1, "", FIELD_BUTTON, "", 0, 0,
     0, COMMON_CONTROL},
    {"#wipe", NULL, 330, 50, 40, 40, "WIPE", 1, "", FIELD_BUTTON, "", 0, 0, 0,
     COMMON_CONTROL},
    {"#mfqrz", NULL, 370, 50, 40, 40, "QRZ", 1, "", FIELD_BUTTON, "", 0, 0, 0,
     COMMON_CONTROL},
    {"#logbook", NULL, 410, 50, 40, 40, "LOG", 1, "", FIELD_BUTTON, "", 0, 0, 0,
     COMMON_CONTROL},
    {"#tune", NULL, 450, 50, 40, 40, "TUNE", 1, "OFF", FIELD_TOGGLE, "ON/OFF",
     0, 0, 0, COMMON_CONTROL},
    {"#text_in", do_text, 5, 70, 285, 20, "TEXT", 70, "text box", FIELD_TEXT,
     "nothing valuable", 0, 128, 0, COMMON_CONTROL},

    {"#toggle_kbd", do_toggle_kbd, 495, 50, 40, 40, "KBD", 40, "OFF",
     FIELD_TOGGLE, "ON/OFF", 0, 0, 0, COMMON_CONTROL},

    /* end of common controls */

    // tx
    {"tx_gain", NULL, 550, -350, 50, 50, "MIC", 40, "50", FIELD_NUMBER, "", 0,
     100, 1, VOICE_CONTROL},

    {"tx_compress", NULL, 600, -350, 50, 50, "COMP", 40, "0", FIELD_NUMBER,
     "ON/OFF", 0, 100, 10, VOICE_CONTROL},
    {"#tx_wpm", NULL, 650, -350, 50, 50, "WPM", 40, "12", FIELD_NUMBER, "", 1,
     50, 1, CW_CONTROL},
    {"rx_pitch", do_pitch, 700, -350, 50, 50, "PITCH", 40, "600", FIELD_NUMBER,
     "", 100, 3000, 10, FT8_CONTROL | DIGITAL_CONTROL},

    {"#tx", NULL, 1000, -1000, 50, 50, "TX", 40, "", FIELD_BUTTON, "RX/TX", 0,
     0, 0, VOICE_CONTROL},

    {"#rx", NULL, 650, -400, 50, 50, "RX", 40, "", FIELD_BUTTON, "RX/TX", 0, 0,
     0, VOICE_CONTROL | DIGITAL_CONTROL},

    {"r1:low", NULL, 660, -350, 50, 50, "LOW", 40, "300", FIELD_NUMBER, "", 100,
     4000, 50, 0, DIGITAL_CONTROL},
    {"r1:high", NULL, 580, -350, 50, 50, "HIGH", 40, "3000", FIELD_NUMBER, "",
     100, 10000, 50, 0, DIGITAL_CONTROL},

    {"spectrum", do_spectrum, 400, 101, 400, 100, "SPECTRUM", 70, "7000 KHz",
     FIELD_STATIC, "", 0, 0, 0, COMMON_CONTROL},
    {"#status", do_status, -1000, -1000, 400, 29, "STATUS", 70, "7000 KHz",
     FIELD_STATIC, "status", 0, 0, 0, 0},

    {"waterfall", do_waterfall, 400, 201, 400, 99, "WATERFALL", 70, "7000 KHz",
     FIELD_STATIC, "", 0, 0, 0, COMMON_CONTROL},
    ...
    {"reverse_scrolling", NULL, 1000, -1000, 50, 50, "RS", 40, "ON",
     FIELD_TOGGLE, "ON/OFF", 0, 0, 0, 0},
    {"tuning_acceleration", NULL, 1000, -1000, 50, 50, "TA", 40, "ON",
     FIELD_TOGGLE, "ON/OFF", 0, 0, 0, 0},
    {"tuning_accel_thresh1", NULL, 1000, -1000, 50, 50, "TAT1", 40, "10000",
     FIELD_NUMBER, "", 100, 99999, 100, 0},
    {"tuning_accel_thresh2", NULL, 1000, -1000, 50, 50, "TAT2", 40, "500",
     FIELD_NUMBER, "", 100, 99999, 100, 0},
    {"mouse_pointer", NULL, 1000, -1000, 50, 50, "MP", 40, "LEFT",
     FIELD_SELECTION, "BLANK/LEFT/RIGHT/CROSSHAIR", 0, 0, 0, 0},
    {"#selband", NULL, 1000, -1000, 50, 50, "SELBAND", 40, "", FIELD_NUMBER, "",
     0, 73, 1, 0},

    // Settings Panel
    {"#mycallsign", NULL, 1000, -1000, 400, 149, "MYCALLSIGN", 70, "CALL",
     FIELD_TEXT, "", 3, 10, 1, 0},
    {"#mygrid", NULL, 1000, -1000, 400, 149, "MYGRID", 70, "NOWHERE",
     FIELD_TEXT, "", 4, 6, 1, 0},
    {"#passkey", NULL, 1000, -1000, 400, 149, "PASSKEY", 70, "123", FIELD_TEXT,
     "", 0, 32, 1, 0},

    // moving global variables into fields
    {"#vfo_a_freq", NULL, 1000, -1000, 50, 50, "VFOA", 40, "14000000",
     FIELD_NUMBER, "", 500000, 30000000, 1, 0},
    {"#vfo_b_freq", NULL, 1000, -1000, 50, 50, "VFOB", 40, "7000000",
     FIELD_NUMBER, "", 500000, 30000000, 1, 0},
    {"#rit_delta", NULL, 1000, -1000, 50, 50, "RIT_DELTA", 40, "000000",
     FIELD_NUMBER, "", -25000, 25000, 1, 0},

    {"#cwinput", NULL, 1000, -1000, 50, 50, "CW_INPUT", 40, "KEYBOARD",
     FIELD_SELECTION, "IAMBIC/IAMBICB/STRAIGHT", 0, 0, 0, CW_CONTROL},
    ...
    {"sidetone", NULL, 1000, -1000, 50, 50, "SIDETONE", 40, "25", FIELD_NUMBER,
     "", 0, 100, 5, CW_CONTROL},
    {"#sent_exchange", NULL, 1000, -1000, 400, 149, "SENT_EXCHANGE", 70, "",
     FIELD_TEXT, "", 0, 10, 1, COMMON_CONTROL},
    {"#contest_serial", NULL, 1000, -1000, 50, 50, "CONTEST_SERIAL", 40, "0",
     FIELD_NUMBER, "", 0, 1000000, 1, COMMON_CONTROL},
    ...
    {"#vswr", NULL, 1000, -1000, 50, 50, "REF", 40, "300", FIELD_NUMBER, "", 0,
     10000, 1, COMMON_CONTROL},
    ...
    {"#abort", NULL, 370, 50, 40, 40, "ESC", 1, "", FIELD_BUTTON, "", 0, 0, 0,
     CW_CONTROL},

    // FT8 should be 4000 Hz
    {"#bw_voice", NULL, 1000, -1000, 50, 50, "BW_VOICE", 40, "2200",
     FIELD_NUMBER, "", 300, 3000, 50, 0},
    {"#bw_cw", NULL, 1000, -1000, 50, 50, "BW_CW", 40, "400", FIELD_NUMBER, "",
     300, 3000, 50, 0},
    {"#bw_digital", NULL, 1000, -1000, 50, 50, "BW_DIGITAL", 40, "4000",
     FIELD_NUMBER, "", 300, 5000, 50, 0},
    ...
    {"#ft8_tx1st", NULL, 1000, -1000, 50, 50, "FT8_TX1ST", 40, "ON",
     FIELD_TOGGLE, "ON/OFF", 0, 0, 0, FT8_CONTROL},
    {"#ft8_repeat", NULL, 1000, -1000, 50, 50, "FT8_REPEAT", 40, "5",
     FIELD_NUMBER, "", 1, 10, 1, FT8_CONTROL},

    {"#telneturl", NULL, 1000, -1000, 400, 149, "TELNETURL", 70,
     "dxc.nc7j.com:7373", FIELD_TEXT, "", 0, 32, 1, 0},

    // soft keyboard
    {"#kbd_q", do_kbd, 0, 300, 50, 50, "", 1, "Q", FIELD_BUTTON, "", 0, 0, 0,
     0},
    {"#kbd_w", do_kbd, 50, 300, 50, 50, "", 1, "W", FIELD_BUTTON, "", 0, 0, 0,
     0},
    {"#kbd_e", do_kbd, 100, 300, 50, 50, "", 1, "E", FIELD_BUTTON, "", 0, 0, 0,
     0},
    {"#kbd_r", do_kbd, 150, 300, 50, 50, "", 1, "R", FIELD_BUTTON, "", 0, 0, 0,
     0},
    {"#kbd_t", do_kbd, 200, 300, 50, 50, "", 1, "T", FIELD_BUTTON, "", 0, 0, 0,
     0},
    {"#kbd_y", do_kbd, 250, 300, 50, 50, "", 1, "Y", FIELD_BUTTON, "", 0, 0, 0,
     0},
    {"#kbd_u", do_kbd, 300, 300, 50, 50, "", 1, "U", FIELD_BUTTON, "", 0, 0, 0,
     0},
    {"#kbd_i", do_kbd, 350, 300, 50, 50, "", 1, "I", FIELD_BUTTON, "", 0, 0, 0,
     0},
    {"#kbd_o", do_kbd, 400, 300, 50, 50, "", 1, "O", FIELD_BUTTON, "", 0, 0, 0,
     0},
    {"#kbd_p", do_kbd, 450, 300, 50, 50, "", 1, "P", FIELD_BUTTON, "", 0, 0, 0,
     0},
    {"#kbd_@", do_kbd, 500, 300, 50, 50, "", 1, "@", FIELD_BUTTON, "", 0, 0, 0,
     0},

    {"#kbd_1", do_kbd, 550, 300, 50, 50, "", 1, "1", FIELD_BUTTON, "", 0, 0, 0,
     0},
    {"#kbd_2", do_kbd, 600, 300, 50, 50, "", 1, "2", FIELD_BUTTON, "", 0, 0, 0,
     0},
    {"#kbd_3", do_kbd, 650, 300, 50, 50, "", 1, "3", FIELD_BUTTON, "", 0, 0, 0,
     0},
    {"#kbd_bs", do_kbd, 700, 300, 100, 50, "", 1, "DEL", FIELD_BUTTON, "", 0, 0,
     0, 0},

    {"#kbd_alt", do_kbd, 0, 350, 50, 50, "", 1, "CMD", FIELD_BUTTON, "", 0, 0,
     0, 0},
    {"#kbd_a", do_kbd, 50, 350, 50, 50, "*", 1, "A", FIELD_BUTTON, "", 0, 0, 0,
     0},
    {"#kbd_s", do_kbd, 100, 350, 50, 50, "", 1, "S", FIELD_BUTTON, "", 0, 0, 0,
     0},
    {"#kbd_d", do_kbd, 150, 350, 50, 50, "", 1, "D", FIELD_BUTTON, "", 0, 0, 0,
     0},
    {"#kbd_f", do_kbd, 200, 350, 50, 50, "", 1, "F", FIELD_BUTTON, "", 0, 0, 0,
     0},
    {"#kbd_g", do_kbd, 250, 350, 50, 50, "", 1, "G", FIELD_BUTTON, "", 0, 0, 0,
     0},
    {"#kbd_h", do_kbd, 300, 350, 50, 50, "", 1, "H", FIELD_BUTTON, "", 0, 0, 0,
     0},
    {"#kbd_j", do_kbd, 350, 350, 50, 50, "", 1, "J", FIELD_BUTTON, "", 0, 0, 0,
     0},
    {"#kbd_k", do_kbd, 400, 350, 50, 50, "'", 1, "K", FIELD_BUTTON, "", 0, 0, 0,
     0},
    {"#kbd_l", do_kbd, 450, 350, 50, 50, "", 1, "L", FIELD_BUTTON, "", 0, 0, 0,
     0},
    {"#kbd_/", do_kbd, 500, 350, 50, 50, "", 1, "/", FIELD_BUTTON, "", 0, 0, 0,
     0},

    {"#kbd_4", do_kbd, 550, 350, 50, 50, "", 1, "4", FIELD_BUTTON, "", 0, 0, 0,
     0},
    {"#kbd_5", do_kbd, 600, 350, 50, 50, "", 1, "5", FIELD_BUTTON, "", 0, 0, 0,
     0},
    {"#kbd_6", do_kbd, 650, 350, 50, 50, "", 1, "6", FIELD_BUTTON, "", 0, 0, 0,
     0},
    {"#kbd_enter", do_kbd, 700, 400, 100, 50, "", 1, "Enter", FIELD_BUTTON, "",
     0, 0, 0, 0},

    {"#kbd_ ", do_kbd, 0, 400, 50, 50, "", 1, "SPACE", FIELD_BUTTON, "", 0, 0,
     0, 0},
    {"#kbd_z", do_kbd, 50, 400, 50, 50, "", 1, "Z", FIELD_BUTTON, "", 0, 0, 0,
     0},
    {"#kbd_x", do_kbd, 100, 400, 50, 50, "", 1, "X", FIELD_BUTTON, "", 0, 0, 0,
     0},
    {"#kbd_c", do_kbd, 150, 400, 50, 50, "", 1, "C", FIELD_BUTTON, "", 0, 0, 0,
     0},
    {"#kbd_v", do_kbd, 200, 400, 50, 50, "", 1, "V", FIELD_BUTTON, "", 0, 0, 0,
     0},
    {"#kbd_b", do_kbd, 250, 400, 50, 50, "", 1, "B", FIELD_BUTTON, "", 0, 0, 0,
     0},
    {"#kbd_n", do_kbd, 300, 400, 50, 50, "", 1, "N", FIELD_BUTTON, "", 0, 0, 0,
     0},
    {"#kbd_m", do_kbd, 350, 400, 50, 50, "", 1, "M", FIELD_BUTTON, "", 0, 0, 0,
     0},
    {"#kbd_,", do_kbd, 400, 400, 50, 50, "", 1, ",", FIELD_BUTTON, "", 0, 0, 0,
     0},
    {"#kbd_.", do_kbd, 450, 400, 50, 50, "", 1, ".", FIELD_BUTTON, "", 0, 0, 0,
     0},
    {"#kbd_?", do_kbd, 500, 400, 50, 50, "", 1, "?", FIELD_BUTTON, "", 0, 0, 0,
     0},

    {"#kbd_7", do_kbd, 550, 400, 50, 50, "", 1, "7", FIELD_BUTTON, "", 0, 0, 0,
     0},
    {"#kbd_8", do_kbd, 600, 400, 50, 50, "", 1, "8", FIELD_BUTTON, "", 0, 0, 0,
     0},
    {"#kbd_9", do_kbd, 650, 400, 50, 50, "", 1, "9", FIELD_BUTTON, "", 0, 0, 0,
     0},
    {"#kbd_0", do_kbd, 700, 350, 50, 50, "", 1, "0", FIELD_BUTTON, "", 0, 0, 0,
     0},

    // macros keyboard

    // row 1
    {"#mf1", do_macro, 0, 1360, 65, 40, "F1", 1, "CQ", FIELD_BUTTON, "", 0, 0,
     0, 0},

    {"#mf2", do_macro, 65, 1360, 65, 40, "F2", 1, "Call", FIELD_BUTTON, "", 0,
     0, 0, 0},

    {"#mf3", do_macro, 130, 1360, 65, 40, "F3", 1, "Reply", FIELD_BUTTON, "", 0,
     0, 0, 0},

    {"#mf4", do_macro, 195, 1360, 65, 40, "F4", 1, "RRR", FIELD_BUTTON, "", 0,
     0, 0, 0},

    {"#mf5", do_macro, 260, 1360, 70, 40, "F5", 1, "73", FIELD_BUTTON, "", 0, 0,
     0, 0},

    {"#mf6", do_macro, 330, 1360, 70, 40, "F6", 1, "Call", FIELD_BUTTON, "", 0,
     0, 0, 0},

    // row 2

    {"#mf7", do_macro, 0, 1400, 65, 40, "F7", 1, "Exch", FIELD_BUTTON, "", 0, 0,
     0, 0},

    {"#mf8", do_macro, 65, 1400, 65, 40, "F8", 1, "Tu", FIELD_BUTTON, "", 0, 0,
     0, 0},

    {"#mf9", do_macro, 130, 1400, 65, 40, "F9", 1, "Rpt", FIELD_BUTTON, "", 0,
     0, 0, 0},

    {"#mf10", do_macro, 195, 1400, 65, 40, "F10", 1, "", FIELD_BUTTON, "", 0, 0,
     0, 0},

    {"#mf11", do_macro, 260, 1400, 70, 40, "F11", 1, "", FIELD_BUTTON, "", 0, 0,
     0, 0},

    {"#mf12", do_macro, 330, 1400, 70, 40, "F12", 1, "", FIELD_BUTTON, "", 0, 0,
     0, 0},

    // row 3

    {"#mfedit", do_macro, 195, 1440, 65, 40, "Edit", 1, "", FIELD_BUTTON, "", 0,
     0, 0, 0},

    {"#mfspot", do_macro, 260, 1440, 70, 40, "Spot", 1, "", FIELD_BUTTON, "", 0,
     0, 0, 0},

    {"#mfkbd", do_macro, 330, 1440, 70, 40, "Kbd", 1, "", FIELD_BUTTON, "", 0,
     0, 0, 0},
...
int set_field(const char *id, const char *value) {
  ...
  if (f->value_type == FIELD_NUMBER) {
    ...
    sprintf(f->value, "%d", v);
             ...
             f->value_type == FIELD_TOGGLE) {
    // toggle and selection are the same type: toggle has just two values
...
int remote_update_field(int i, char *text) {
  ...
  if (!strcmp(f->label, "STATUS")) {
    ...
    sprintf(text, "STATUS %04d/%02d/%02d %02d:%02d:%02dZ", tmp->tm_year + 1900,
...
static int mode_id(const char *mode_str) {
  if (mode_str[0] == 'C' && mode_str[1] == 'W' && mode_str[2] == 0)
    return MODE_CW;
  else if (mode_str[0] == 'C' && mode_str[1] == 'W' && mode_str[2] == 'R' &&
           mode_str[3] == 0)
    return MODE_CWR;
  else if (mode_str[0] == 'U' && mode_str[1] == 'S' && mode_str[2] == 'B' &&
           mode_str[3] == 0)
    return MODE_USB;
  else if (mode_str[0] == 'L' && mode_str[1] == 'S' && mode_str[2] == 'B' &&
           mode_str[3] == 0)
    return MODE_LSB;
  else if (mode_str[0] == 'F' && mode_str[1] == 'T' && mode_str[2] == '8' &&
           mode_str[3] == 0)
    return MODE_FT8;
  else if (mode_str[0] == 'N' && mode_str[1] == 'B' && mode_str[2] == 'F' &&
           mode_str[3] == 'M')
    return MODE_NBFM;
  else if (mode_str[0] == 'A' && mode_str[1] == 'M' && mode_str[2] == '0')
    return MODE_AM;
  else if (mode_str[0] == '2' && mode_str[1] == 'T' && mode_str[2] == 'O' &&
           mode_str[3] == 'N')
    return MODE_2TONE;
  else if (mode_str[0] == 'D' && mode_str[1] == 'I' && mode_str[2] == 'G' &&
           mode_str[3] == 'I')
    return MODE_DIGITAL;
  return -1;
}
...
static void save_user_settings(int forced) {
  ...
  if (!f) {
    ...
    settings_updated =
        0; // stop repeated attempts to write if file cannot be opened.
    last_save_at = now;
    return;
  }
...
void enter_qso() {
  ...
  if (strlen(callsign) < 3 || strlen(rst_sent) < 1 ||
      strlen(rst_received) < 1) {
    printf("log entry is empty [%s], [%s], [%s], no log created\n", callsign,
           rst_sent, rst_received);
    return;
  }

  if (logbook_count_dup(field_str("CALL"), 60)) {
    printf("Duplicate log entry not accepted for %s within two minutes of last "
           "entry of %s.\n",
           callsign, callsign);
    return;
  }
  logbook_add(get_field("#contact_callsign")->value,
              get_field("#rst_sent")->value, get_field("#exchange_sent")->value,
              get_field("#rst_received")->value,
              get_field("#exchange_received")->value);
  char buff[100];
  sprintf(buff, "Logged: %s %s-%s %s-%s\n", field_str("CALL"),
          field_str("SENT"), field_str("NR"), field_str("RECV"),
          field_str("EXCH"));
    ...
    if (f) {
      ...
      /*
              ...
              if (ptr != NULL)
              {
                      ...
                      if (ix < 0)
                      {
                              // printf("Band stack index for %c%cm set to
         0!\n", *(ptr+1), *(ptr+2)); ix = 0;
                      }
...
int do_text(struct field *f, int event, int a, int b, int c) {
  ...
  if (event == FIELD_EDIT) {
    ...
    if (f->value[0] == COMMAND_ESCAPE && strlen(f->value) > 1 &&
        (a == '\n' || a == MIN_KEY_ENTER)) {
      cmd_exec(f->value + 1);
      f->value[0] = 0;
      update_field(f);
...
int do_tuning(struct field *f, int event, int a, int b, int c) {
  ...
  if (event == FIELD_EDIT) {
    ...
    if (!strcmp(get_field("tuning_acceleration")->value, "ON")) {
      ...
      uint64_t delta_us =
          (this_change_time.tv_sec - last_change_time.tv_sec) * 1000000 +
...
int do_macro(struct field *f, int event, int a, int b, int c) {
  ...
  if (event == FIELD_UPDATE) {
    int fn_key = atoi(
        f->cmd + 3); // skip past the '#mf' and read the function key number
...
int do_record(struct field *f, int event, int a, int b, int c) {
  if (event == FIELD_DRAW) {
    ...
    // draw_text(gfx, f->x + f->width/2 - width/2, label_y, duration,
    // f->font_index);
    return 1;
  }
  return 0;
...
static void zbitx_logs() {
  ...
  while (fgets(row, sizeof(row), pf)) {
    ...
    // printf(row_response);
    i2cbb_write_i2c_block_data(ZBITX_I2C_ADDRESS, '{', strlen(row_response),
                               row_response);
  }
  fclose(pf);
}
...
void zbitx_poll(int all) {
  ...
  for (int i = 0; active_layout[i].cmd[0] > 0; i++) {
    ...
    if (all || f->updated_at > last_update) {
      ...
      retry = 3;
      do {
        e = i2cbb_write_i2c_block_data(ZBITX_I2C_ADDRESS, '{', strlen(buff),
                                       buff);
        if (!e) {
          if (retry < 3)
            printf("Sucess on %d\n", retry);
  ...
  while (q_length(&q_zbitx_console) > 0) {
    ...
    e = i2cbb_write_i2c_block_data(ZBITX_I2C_ADDRESS, '{', strlen(remote_cmd),
                                   remote_cmd);
  }
...
void zbitx_init() {
  ...
  if (!e) {
    ...
    e = i2cbb_write_i2c_block_data(ZBITX_I2C_ADDRESS, '{', strlen(VER_STR),
                                   VER_STR);
...
bool ui_tick() {
  ...
  while (q_length(&q_remote_commands) > 0) {
    ...
    int c, i;
    for (i = 0;
         i < sizeof(remote_cmd) - 2 && (c = q_read(&q_remote_commands)) >= ' ';
         i++) {
      remote_cmd[i] = c;
    }
    remote_cmd[i] = 0;
  ...
  */
  ...
  if (ticks >= tick_count) {
    ...
    char new_value[20];
    while (atoi(get_field("r1:low")->value) >
           atoi(get_field("r1:high")->value)) {
      sprintf(new_value, "%d",
              atoi(get_field("r1:high")->value) + get_field("r1:high")->step);
...
void change_band(char *request) {
  ...
  for (old_band = 0; old_band < max_bands; old_band++)
    if (band_stack[old_band].start <= old_freq &&
        old_freq <= band_stack[old_band].stop)
      break;
  ...
  // this fixes bug with filter settings not being applied after a band change,
  // not sure why it's a bug - k3ng 2022-09-03
...
void do_control_action(char *cmd) {
  ...
  if (!strcmp(request, "CLOSE")) {
    ...
    set_filter_high_low(bw); // calls do_control_action again to set LOW and
                             // HIGH
  ...
  else if (!strcmp(request, "80M") || !strcmp(request, "60M") ||
           !strcmp(request, "40M") || !strcmp(request, "30M") ||
           !strcmp(request, "20M") || !strcmp(request, "17M") ||
           !strcmp(request, "15M") || !strcmp(request, "12M") ||
           !strcmp(request, "10M")) {
    change_band(request);
...
int main(int argc, char *argv[]) {
  ...
  // If a parameter was passed on the command line, use it as the audio output
  // device
  ...
  if (ini_parse(STATEDIR "/user_settings.ini", user_settings_handler, NULL) <
      0) {
